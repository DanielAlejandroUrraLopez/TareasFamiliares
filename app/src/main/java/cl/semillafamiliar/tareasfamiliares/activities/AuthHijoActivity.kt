...
import cl.semillafamiliar.tareasfamiliares.enum.UtilIntEnum
import cl.semillafamiliar.tareasfamiliares.enum.UtilStringEnum
import cl.semillafamiliar.tareasfamiliares.service.FirestoreService
    ...
    private  fun setup(){
        ...
        registerButton.setOnClickListener {
            ...
            if( firestoreConect.validateCreateUser(nomUserTextView.text.toString()) == UtilIntEnum.CERO.num){
                ...
                Toast.makeText(this,
                    UtilStringEnum.USUARIO_CON_ESE_NOMBRE_YA_ESTA_REGISTRADO.text, Toast.LENGTH_SHORT).show()
            }
